...
public class DB extends NativeObject {
    ...
    public DB(File path) throws NullPointerException{
        super();
    ...
    public void put(byte[] key, byte[] value) throws NullPointerException{
    ...
    public byte[] get(byte[] key) throws NullPointerException{
        return get(null, key);
    }

    public byte[] get(Snapshot snapshot, byte[] key) throws NullPointerException{
        assertOpen("Database is closed");
        if (key == null) {
            throw new NullPointerException();
        }
    ...
    public byte[] get(ByteBuffer key) throws NullPointerException{
        return get(null, key);
    }

    public byte[] get(Snapshot snapshot, ByteBuffer key) throws NullPointerException{
        assertOpen("Database is closed");
        if (key == null) {
            throw new NullPointerException();
        }
    ...
    public void delete(byte[] key) throws NullPointerException{
        assertOpen("Database is closed");
        if (key == null) {
            throw new NullPointerException();
        }
    ...
    public void write(WriteBatch batch) throws NullPointerException{
        assertOpen("Database is closed");
        if (batch == null) {
            throw new NullPointerException();
        }
